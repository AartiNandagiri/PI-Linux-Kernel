...
#define PI_SCALE 8
#define PARAMETER_SCALE 10000000000000000
...
static void calculate_probability(struct Qdisc *sch)
{
	 ...
	 */
	a = q->params.a * (MAX_PROB / PARAMETER_SCALE);
	b = q->params.b * (MAX_PROB / PARAMETER_SCALE);

	oldprob = q->vars.prob;
	q->vars.prob += a * (u64)(qlen - q->params.qref) - b * (u64)(qlen_old - q->params.qref);
	// q->vars.prob += delta;
